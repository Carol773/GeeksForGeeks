<h2><a href="https://www.geeksforgeeks.org/problems/largest-element-in-array4009/1?page=5&category=Arrays,Mathematical,Strings,Sorting,Hash,Matrix,Linked%20List,Stack,Searching,Binary%20Search,Prime%20Number,two-pointer-algorithm,Queue,Map,sieve,sliding-window,palindrome,Fibonacci,prefix-sum,set,factorial,union-find,Kadane&sortBy=submissions">Largest Element in Array</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>A[] </strong>of size <strong>n</strong>. The task is to find the largest element in it.</span><br>
&nbsp;</p>
