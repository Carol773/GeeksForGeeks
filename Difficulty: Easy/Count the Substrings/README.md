<h2><a href="https://www.geeksforgeeks.org/problems/count-the-substrings--141634/1?page=1&category=Strings&difficulty=Easy&status=unsolved&sortBy=submissions">Count the Substrings</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string&nbsp;<strong>S</strong>. The task is to count the number of substrings which contains equal number of lowercase and uppercase letters.&nbsp;</span></p>
