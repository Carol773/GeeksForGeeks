<h2><a href="https://www.geeksforgeeks.org/problems/unusual-string-sort0405/1?page=2&category=Strings&difficulty=Easy&status=unsolved&sortBy=submissions">Unusual String Sort</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string composed of both lowercase and uppercase letters. Sort it in such a manner such that the uppercase and lowercase letter comes in an alternate manner but in sorted way.</span></p>
