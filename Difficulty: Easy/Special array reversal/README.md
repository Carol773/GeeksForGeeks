<h2><a href="https://www.geeksforgeeks.org/problems/special-array-reversal2328/1?page=5&category=Strings&difficulty=Easy,Medium&status=unsolved&sortBy=submissions">Special array reversal</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string <strong>S</strong>, containing special characters and all the alphabets, reverse the string without<br>affecting the positions of the special characters.</span></p>
