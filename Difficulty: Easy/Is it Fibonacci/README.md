<h2><a href="https://www.geeksforgeeks.org/problems/is-it-fibonacci--170647/1?page=2&category=Arrays&difficulty=Easy&status=unsolved&sortBy=submissions">Is it Fibonacci</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Geek just learned&nbsp;about Fibonacci numbers. </span></p>
