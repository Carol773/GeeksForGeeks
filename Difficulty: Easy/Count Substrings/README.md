<h2><a href="https://www.geeksforgeeks.org/problems/count-substrings0427/1?page=1&category=Strings&difficulty=Easy&status=unsolved&sortBy=submissions">Count Substrings</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary string<strong> S.</strong> The task is to count the number of substrings that starts and end with 1.<br>
