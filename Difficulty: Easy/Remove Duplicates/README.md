<h2><a href="https://www.geeksforgeeks.org/problems/remove-duplicates3034/1?page=1&category=Strings&difficulty=Easy,Medium&status=unsolved&sortBy=submissions">Remove Duplicates</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string without spaces, the task is to remove duplicates from it. </span></p>
