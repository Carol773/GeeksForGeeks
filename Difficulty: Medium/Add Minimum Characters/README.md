<h2><a href="https://www.geeksforgeeks.org/problems/add-minimum-characters--170648/1?page=1&category=Arrays,Strings&company=Samsung&status=unsolved&sortBy=submissions">Add Minimum Characters</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string <strong>str</strong>, find the minimum characters to be added at front of the string to make it a palindrome.</span></p>
