<h2><a href="https://www.geeksforgeeks.org/problems/minimum-sum4058/1?page=2&category=Arrays,two-pointer-algorithm,sliding-window&status=unsolved&sortBy=submissions">Minimum sum</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array Arr&nbsp;of size N such that each element is from the range&nbsp;0 to 9. Find the minimum possible sum of two numbers formed using the&nbsp;elements&nbsp;of the array. All digits in the given array must be used to form the two numbers.</span></p>
