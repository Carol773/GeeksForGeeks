<h2><a href="https://www.geeksforgeeks.org/problems/find-the-median0527/1?page=1&category=Mathematical,number-theory&status=unsolved&sortBy=submissions">Find the median</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array arr[] of N integers, calculate the median.</span></p>
