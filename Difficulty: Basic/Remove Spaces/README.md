<h2><a href="https://www.geeksforgeeks.org/problems/remove-spaces0128/1?page=2&category=Strings&status=unsolved&sortBy=submissions">Remove Spaces</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string, remove spaces from it.&nbsp;</span></p>
