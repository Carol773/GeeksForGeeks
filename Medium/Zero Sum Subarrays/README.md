<h2><a href="https://www.geeksforgeeks.org/problems/zero-sum-subarrays1825/1?page=2&category=Arrays,two-pointer-algorithm&difficulty=Easy,Medium&status=unsolved&sortBy=submissions">Zero Sum Subarrays</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p>You are given an array arr[] of size n. Find&nbsp;the total count of sub-arrays having their sum equal to 0.</p>
