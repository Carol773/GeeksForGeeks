<h2><a href="https://www.geeksforgeeks.org/problems/spirally-traversing-a-matrix-1587115621/1?page=4&category=Arrays,Mathematical,Strings,Sorting,Hash,Matrix,Linked%20List,Stack,Searching,Binary%20Search,Prime%20Number,Queue,Map,sliding-window,prefix-sum,set,union-find,Kadane&sortBy=submissions">Spirally traversing a matrix</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a&nbsp;matrix&nbsp;of size r*c. Traverse the matrix in spiral form.</span></p>
